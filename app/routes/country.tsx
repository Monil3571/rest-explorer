...
export default function Country({ loaderData }: Route.ComponentProps) {
  ...
  return (
    <div className="p-6 grid grid-cols-1 md:grid-cols-2 gap-8 place-items-center gap-y-10">
      <div className="flex flex-col gap-5 items-center md:items-start">
        <h2 className=" text-6xl md:text-8xl font-bold text-gray-900">{country.name}</h2>
        <div className="space-y-2 text-gray-700 text-2xl">
          <p>
